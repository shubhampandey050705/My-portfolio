          ...
          >
            ...
            <div className="relative pl-20">
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700">
                <div className="mb-4">
                  <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Virtual Intern</h3>
                  <h4 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-2">Eduskills & AICTE</h4>
                  <p className="text-gray-500 dark:text-gray-400 font-medium">Data Analytics Program</p>
                </div>
