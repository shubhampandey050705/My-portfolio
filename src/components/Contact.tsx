  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_email: "shubhampandey050705@gmail.com" // Your email
      };
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Have a project in mind, want to collaborate on data science projects, or just want to say hello? 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-white/20">
              <h3 className="text-3xl font-bold mb-8 text-slate-800">Let's Connect</h3>
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-lg">Phone</p>
                    <a 
                      href="tel:+917752884451" 
                      className="text-blue-600 hover:text-blue-700 transition-colors duration-200 text-lg"
                    >
                      +91 7752884451
                    </a>
                ...
                >
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-lg">GitHub</p>
                    <a 
                      href="#" 
                      className="text-blue-600 hover:text-blue-700 transition-colors duration-200 text-lg"
                    >
                      github.com/shubhampandey
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-lg">LinkedIn</p>
                    <a 
                      href="#" 
                      className="text-blue-600 hover:text-blue-700 transition-colors duration-200 text-lg"
                    >
                      linkedin.com/in/shubhampandey
                    </a>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl">
                <h4 className="font-bold text-slate-800 mb-2">Quick Response Guarantee</h4>
          ...
          >
            <h3 className="text-3xl font-bold mb-8 text-slate-800">Send Me a Message</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-slate-700 font-medium"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none text-slate-700 font-medium"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white py-4 px-8 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
              >
                {isSubmitting ? (
                  <>
